    ...
    return (
        <section>
            ...
            <div className="flex flex-col justify-center items-center mt-[15vh] px-5 lg:mt-[20vh]">
                ...
                <div className="mb-30 h-auto lg:h-[600px] w-[85vw] rounded-3xl shadow-md relative">
                    {/* Imagem Desktop */}
                    <Image className="hidden lg:block object-cover object-center rounded-3xl lg:mt-10" src={project.src} fill alt="imagem de projeto" />
                    {/* Imagem Mobile */}
                    <Image className="block lg:hidden rounded-3xl w-full h-auto" src={project.srcMobile || project.src} width={0} height={0} sizes="100vw" alt="imagem de projeto mobile" />
