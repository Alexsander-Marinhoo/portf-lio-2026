...
export default function SliderProjects(){
    ...
    return(
        <div className="my-15 flex flex-col items-center justify-center gap-10 relative overflow-hidden" ref={refContainerSlider}>
            <div className="flex gap-8 w-[250vw] md:w-[180vw] lg:w-[120vw]" ref={refSlider1}>
                {reposArray.slice(0 , 4).map((project , index) => (
                    <div key={index} className="w-1/4 h-auto flex flex-col gap-2 items-center justify-center font-mono">
